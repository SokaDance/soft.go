...
func ToAnyArray[T any](c ECollection[T]) []any {
	return ToArray[T,any](c, toAny[T] )
}
...
func (l *eCollectionDelegate[T,U,D]) AddAll(c ECollection[U]) bool {
	return l.delegate.AddAll(ToCollection[U,T](c,l.convertFrom,l.convertTo) )
}
...
func (l *eCollectionDelegate[T,U,D]) RemoveAll(c ECollection[U]) bool {
	return l.delegate.RemoveAll(ToCollection[U,T](c,l.convertFrom,l.convertTo) )
}

func (l *eCollectionDelegate[T,U,D]) RetainAll(c ECollection[U]) bool {
	return l.delegate.RetainAll(ToCollection[U,T](c,l.convertFrom,l.convertTo))
}
...
func (l *eCollectionDelegate[T,U,D]) ToArray() []U {
	return ToArray[T,U](l.delegate,l.convertTo)
}
