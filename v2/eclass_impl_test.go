...
func TestEClassEGetFromID(t *testing.T) {
	...
	assert.Equal(t, o.GetEAllAttributes(), FromAnyObjectList[EAttribute](o.EGetFromID(ECLASS__EALL_ATTRIBUTES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAllAttributes().(EObjectList[EAttribute]).GetUnResolvedList(), FromAnyObjectList[EAttribute](o.EGetFromID(ECLASS__EALL_ATTRIBUTES, false).(EObjectList[any])))
	assert.Equal(t, o.GetEAllContainments(), FromAnyObjectList[EReference](o.EGetFromID(ECLASS__EALL_CONTAINMENTS, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAllContainments().(EObjectList[EReference]).GetUnResolvedList(), FromAnyObjectList[EReference](o.EGetFromID(ECLASS__EALL_CONTAINMENTS, false).(EObjectList[any])))
	assert.Equal(t, o.GetEAllOperations(), FromAnyObjectList[EOperation](o.EGetFromID(ECLASS__EALL_OPERATIONS, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAllOperations().(EObjectList[EOperation]).GetUnResolvedList(), FromAnyObjectList[EOperation](o.EGetFromID(ECLASS__EALL_OPERATIONS, false).(EObjectList[any])))
	assert.Equal(t, o.GetEAllReferences(), FromAnyObjectList[EReference](o.EGetFromID(ECLASS__EALL_REFERENCES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAllReferences().(EObjectList[EReference]).GetUnResolvedList(), FromAnyObjectList[EReference](o.EGetFromID(ECLASS__EALL_REFERENCES, false).(EObjectList[any])))
	assert.Equal(t, o.GetEAllStructuralFeatures(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__EALL_STRUCTURAL_FEATURES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAllStructuralFeatures().(EObjectList[EStructuralFeature]).GetUnResolvedList(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__EALL_STRUCTURAL_FEATURES, false).(EObjectList[any])))
	assert.Equal(t, o.GetEAllSuperTypes(), FromAnyObjectList[EClass](o.EGetFromID(ECLASS__EALL_SUPER_TYPES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAllSuperTypes().(EObjectList[EClass]).GetUnResolvedList(), FromAnyObjectList[EClass](o.EGetFromID(ECLASS__EALL_SUPER_TYPES, false).(EObjectList[any])))
	assert.Equal(t, o.GetEAttributes(), FromAnyObjectList[EAttribute](o.EGetFromID(ECLASS__EATTRIBUTES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEAttributes().(EObjectList[EAttribute]).GetUnResolvedList(), FromAnyObjectList[EAttribute](o.EGetFromID(ECLASS__EATTRIBUTES, false).(EObjectList[any])))
	assert.Equal(t, o.GetEContainmentFeatures(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__ECONTAINMENT_FEATURES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEContainmentFeatures().(EObjectList[EStructuralFeature]).GetUnResolvedList(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__ECONTAINMENT_FEATURES, false).(EObjectList[any])))
	assert.Equal(t, o.GetECrossReferenceFeatures(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__ECROSS_REFERENCE_FEATURES, true).(EObjectList[any])))
	assert.Equal(t, o.GetECrossReferenceFeatures().(EObjectList[EStructuralFeature]).GetUnResolvedList(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__ECROSS_REFERENCE_FEATURES, false).(EObjectList[any])))
	...
	assert.Equal(t, o.GetEOperations(), FromAnyObjectList[EOperation](o.EGetFromID(ECLASS__EOPERATIONS, true).(EObjectList[any])))
	assert.Equal(t, o.GetEReferences(), FromAnyObjectList[EReference](o.EGetFromID(ECLASS__EREFERENCES, true).(EObjectList[any])))
	assert.Equal(t, o.GetEReferences().(EObjectList[EReference]).GetUnResolvedList(), FromAnyObjectList[EReference](o.EGetFromID(ECLASS__EREFERENCES, false).(EObjectList[any])))
	assert.Equal(t, o.GetEStructuralFeatures(), FromAnyObjectList[EStructuralFeature](o.EGetFromID(ECLASS__ESTRUCTURAL_FEATURES, true).(EObjectList[any])))
	assert.Equal(t, o.GetESuperTypes(), FromAnyObjectList[EClass](o.EGetFromID(ECLASS__ESUPER_TYPES, true).(EObjectList[any])))
	assert.Equal(t, o.GetESuperTypes().(EObjectList[EClass]).GetUnResolvedList(), FromAnyObjectList[EClass](o.EGetFromID(ECLASS__ESUPER_TYPES, false).(EObjectList[any])))
}
