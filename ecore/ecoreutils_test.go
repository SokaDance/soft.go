...
func TestEcoreUtilsCopyAllAttribute(t *testing.T) {
	...
	list := NewImmutableEList([]EObject{eObject1, eObject2})
...
func TestEcoreUtilsCopyContainment(t *testing.T) {
	...
	ePackage.SetEFactoryInstance(eFactory)
	ePackage.GetEClassifiers().AddAll(NewImmutableEList([]EClassifier{eClass1, eClass2}))
	...
	eAttribute2.SetName("attribute2")
	eAttribute2.SetEType(ecorePackage.GetEString())
	eClass2.GetEStructuralFeatures().AddAll(NewImmutableEList([]EStructuralFeature{eAttribute1, eAttribute2}))
...
func TestEcoreUtilsCopyReferences(t *testing.T) {
	...
	eClass1.GetEStructuralFeatures().AddAll(NewImmutableEList([]EStructuralFeature{eReference1, eReference2}))
