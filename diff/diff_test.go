...
func TestDiff(t *testing.T) {
	for _, tt := range []struct {
		...
		newArray        []int
		entries         []Entry[int]
		mockVisitorInit func(mock *MockVisitor[int])
	}{
		// Add
		{[]int{1, 2, 3, 4}, []int{5, 1, 2, 3, 4}, []Entry[int]{{Index: 0, Element: 5, IsAddition: true}}, func(m *MockVisitor[int]) { m.On("HandleAdd", 0, 5).Once() }},
		{[]int{1, 2, 3, 4}, []int{1, 2, 5, 3, 4}, []Entry[int]{{Index: 2, Element: 5, IsAddition: true}}, func(m *MockVisitor[int]) { m.On("HandleAdd", 2, 5).Once() }},
		{[]int{1, 2, 3, 4}, []int{1, 2, 3, 4, 5}, []Entry[int]{{Index: 4, Element: 5, IsAddition: true}}, func(m *MockVisitor[int]) { m.On("HandleAdd", 4, 5).Once() }},

		// Remove
		{[]int{1, 2, 3, 4}, []int{2, 3, 4}, []Entry[int]{{Index: 0, Element: 1, IsAddition: false}}, func(m *MockVisitor[int]) { m.On("HandleRemove", 0, 1).Once() }},
		{[]int{1, 2, 3, 4}, []int{1, 2, 4}, []Entry[int]{{Index: 2, Element: 3, IsAddition: false}}, func(m *MockVisitor[int]) { m.On("HandleRemove", 2, 3).Once() }},
		{[]int{1, 2, 3, 4}, []int{1, 2, 3}, []Entry[int]{{Index: 3, Element: 4, IsAddition: false}}, func(m *MockVisitor[int]) { m.On("HandleRemove", 3, 4).Once() }},

		// Move
		{[]int{1, 2, 3, 4}, []int{2, 3, 4, 1}, []Entry[int]{{Index: 0, Element: 1, IsAddition: false}, {Index: 3, Element: 1, IsAddition: true}}, func(m *MockVisitor[int]) { m.On("HandleMove", 0, 3, 1).Once() }},
		{[]int{1, 2, 3, 4}, []int{4, 1, 2, 3}, []Entry[int]{{Index: 3, Element: 4, IsAddition: false}, {Index: 0, Element: 4, IsAddition: true}}, func(m *MockVisitor[int]) { m.On("HandleMove", 3, 0, 4).Once() }},
		{[]int{1, 2, 3, 4}, []int{1, 3, 2, 4}, []Entry[int]{{Index: 2, Element: 3, IsAddition: false}, {Index: 1, Element: 3, IsAddition: true}}, func(m *MockVisitor[int]) { m.On("HandleMove", 2, 1, 3).Once() }},
		{[]int{1, 2, 3, 4}, []int{1, 3, 4, 5, 6, 2}, []Entry[int]{{Index: 1, Element: 2, IsAddition: false}, {Index: 3, Element: 2, IsAddition: true}, {Index: 3, Element: 5, IsAddition: true}, {Index: 4, Element: 6, IsAddition: true}}, func(m *MockVisitor[int]) {
		...
		// Replace
		{[]int{1, 2, 3, 4}, []int{1, 2, 3, 5}, []Entry[int]{{Index: 3, Element: 5, IsAddition: true}, {Index: 4, Element: 4, IsAddition: false}}, func(m *MockVisitor[int]) { m.On("HandleReplace", 3, 4, 5).Once() }},

		// Add + Remove
		{[]int{1, 2, 3, 4}, []int{1, 2, 5, 3}, []Entry[int]{{Index: 2, Element: 5, IsAddition: true}, {Index: 4, Element: 4, IsAddition: false}}, func(m *MockVisitor[int]) {
